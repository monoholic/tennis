    ...
    <div class="container">
        <div class="home_content text-center">
            <div class="blue_bg text-vertical-center">
                ...
                <div class="btn-area">
                    <div class="go-ongoing center-flexbox">
        ...
        <div class="row itd_ct">
            <div class="main_feature text-center">
                <ul class="ranking-tab">
                    <li class="center-flexbox" onclick="onClickRankingTab(this)"><a>MAJOR</a></li>
                    <li class="center-flexbox" onclick="onClickRankingTab(this)"><a>TOUR</a></li>
                    <li class="center-flexbox" onclick="onClickRankingTab(this)"><a>CHALLENGER</a></li>
                    <li class="center-flexbox" onclick="onClickRankingTab(this)"><a>CIRCUIT</a></li>
                </ul>
